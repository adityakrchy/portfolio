        ...
        <>
          ...
          <main className="container mx-auto px-4 py-20">
            <section id="home" className="min-h-screen flex items-center justify-center py-20 relative">
              ...
              >
                ...
                >
                  <motion.a
                    href="mailto:adityakrchy101@gmail.com"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                ...
                >
                  {[
                    { icon: Github, href: 'https://github.com/adityakrchy', label: 'GitHub' },
                    { icon: Linkedin, href: 'https://linkedin.com/in/aditya-kumar-choudhary/', label: 'LinkedIn' },
                    { icon: Mail, href: 'mailto:adityakrchy101@gmail.com', label: 'Email' }
                  ].map((social, index) => (
                    <motion.a
                      key={index}
                      href={social.href}
                  ...
                  <div className="font-mono space-y-4 text-zinc-300">
                    <div className="typing-effect">
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        ...
                        <span>
                          Hi! I'm <span className="text-green-500 font-semibold">Aditya Kumar Choudhary</span>,
                          a <span className="text-blue-400 font-semibold">Software Engineer</span> at TCS.
                        </span>
                      </div>
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        <span className="text-zinc-600 select-none">02</span>
                        <span>
                          With <span className="text-yellow-500">nearly a year</span> of experience in building
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['Python', 'JavaScript', 'TypeScript', 'C', 'C++', 'SQL', 'Java'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['React.js', 'Next.js', 'Express.js', 'Tailwind', 'Node.js'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['Azure', 'Docker', 'SonarQube', 'BuildMaster', 'Jenkins', 'Git', 'CI/CD'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
              ...
              <Window title="projects.json" isActive>
                <div className="space-y-8">
                  {[
                    {
                      id: '01',
                      title: 'Online Collaboration System',
                      year: '2022',
                      tech: ['React', 'Tailwind', 'WebRTC', 'Firebase'],
                      description: 'An online video conferencing webapp to share, collaborate and communicate in real time. Also comes with a chat feature.'
                    },
                    {
                      id: '02',
                      title: 'CodeHaven',
                      year: '2022',
                      tech: ['React', 'Tailwind', 'Node.js', 'MongoDB', 'WebSocket'],
                      description: 'A coding paltform for fellow developers and new beginners to practice coding along with an IDE with real time collaboration.'
                    },
                    {
                      id: '03',
                      title: 'ELearn Lab - EdTech Platform',
                      year: '2023',
                      tech: ['Flutter', 'Android Studio', 'Firebase', 'Node.js', 'Stripe'],
                      description: 'An Ed.Tech platform catering to tutors enabling them to conduct online classes and upload recorded lectures for students access.'
                    }
                  ].map((project) => (
                    <motion.div
                      key={project.id}
            ...
            <section id="career" className="py-20">
              <div className="flex items-center justify-between mb-8">
                ...
                >
                  <FileText className="w-4 h-4" />
                  <span className="font-mono text-sm">Aditya_Kumar_Choudhary_resume.pdf</span>
                </motion.a>
              </div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>Tata Consultancy Services</span>
                        <span className="text-zinc-500">•</span>
                        <span className="text-zinc-500">Kochi</span>
                      </div>

                      <ul className="space-y-3 text-zinc-400">
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Experienced in utilizing cloud platforms like Azure for scalable solutions.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Skilled in CI/CD tools such as Jenkins to streamline deployment pipelines.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Proficient in leveraging SonarQube for maintaining code quality and standards.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Hands-on experience with Docker and Kubernetes for containerization and orchestration.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Worked with BuildMaster for managing and automating build processes.</span>
                        </li>
                      </ul>

                      <div className="flex flex-wrap gap-2 pt-2">
                        {['Azure', 'Jenkins', 'BuildMaster', 'SonarQube', 'Docker', 'CI/CD'].map((tech) => (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-blue-500 font-mono text-sm">Nov 2023 - Jan 2024</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>RadicalX AI</span>
                        <span className="text-zinc-500">•</span>
                      ...
                      <ul className="space-y-3 text-zinc-400">
                        <li className="flex gap-2">
                          ...
                          <span>Actively contributed to the development of "ReX," an AI Coach designed to provide personalized coaching and mentorship to learners throughout their career journey.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Leveraged technologies such as OpenAI, Firebase, TensorFlow, Node.js, and React in the development process.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Collaborated with a dynamic team of developers at RadicalX, gaining valuable experience in teamwork and software development practices.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Gained hands-on exposure to real-world machine learning applications and their integration into functional software systems.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Enhanced expertise in software engineering practices through active participation in the project's lifecycle.</span>
                        </li>
                      </ul>
                      <div className="flex flex-wrap gap-2 pt-2">
                        {['Python', 'ML', 'React', 'TensorFlow', 'OpenAI'].map((tech) => (
                          <span key={tech} className="px-2 py-1 bg-zinc-800/50 rounded-full text-xs text-zinc-400">
                            {tech}
                          </span>
                        ))}
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-zinc-500">•</span>
                        <span className="text-zinc-500">Mohali, Punjab, India</span>
                      </div>
                      <div className="text-zinc-400">
                        <span className="text-purple-500 font-semibold">CGPA:</span> 7.95/10.0
                      </div>
                      <div className="flex flex-wrap gap-2 pt-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Window title="me-online.sh">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { icon: Mail, label: 'adityakrchy101@gmail.com', href: 'mailto:adityakrchy101@gmail.com' },
                        { icon: Phone, label: '+91 8709664438', href: 'tel:+918709664438' },
                        { icon: MapPin, label: 'Kochi, Kerela, India', href: null },
                      ].map((contact, index) => (
                        <motion.div
                          key={index}
                    ...
                    <div className="pt-4 border-t border-zinc-800">
                      <div className="space-y-4">
                        {[
                          { icon: Github, label: 'github.com/adityakrchy', href: 'https://github.com/adityakrchy' },
                          { icon: Linkedin, label: 'linkedin.com/in/aditya-kumar-choudhary', href: 'https://www.linkedin.com/in/aditya-kumar-choudhary' },
                          { icon: Code2, label: 'leetcode.com/adityakrchy', href: 'https://leetcode.com/adityakrchy' },
                        ].map((social, index) => (
                          <motion.div
                            key={index}
                            whileHover={{ x: 4 }}
          ...
          <footer className="bg-black/80 backdrop-blur-sm py-8">
            <div className="container mx-auto px-6 text-center">
              <p className="text-zinc-400">Copyright &copy; 2024 Aditya Kumar Choudhary. All rights reserved.</p>
            </div>
          </footer>
        </>
      )}
